...
function Header() {
  ...
  return (
    <header class="bg-gr">
     <nav className="fixed top-0 left-0 w-full h-auto bg-red z-10 flex items-center justify-around">
      
      <h3 className="relative heading font-bold md:basis-1/6 text-3xl xs:basis-4/12 z-50 mb-5 mt-5 ">News_Aggregator</h3>
